...
using System.Web;
    ...
    public class DBmovies
    {
        ...
        public DBmovies(string sqlCon,string top)
        {
            arr = new List<Movies>();
            Getmovies(sqlCon,top);
        }
        private string Getmovies(string sqlCon,string top)
        {
        string query = "SELECT TOP"+" "+top+" "  +"* FROM [dbo].[Movie] ORDER BY [rating] DESC";
